    ...
    class Main {
        ...
        getBalance() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                bcp = yield Main.getSgasBalanceByAddress(BlackCat.tools.CoinTool.id_BCP, Main.user.info.wallet);
                bct = yield Main.getSgasBalanceByAddress(BlackCat.tools.CoinTool.id_BCT, Main.user.info.wallet);
                var callback_data = {
                    sgas: sgas,
                    gas: gas,
                    bcp: bcp,
    ...
    class LangJP extends BlackCat.LangBase {
        constructor() {
            ...
            this.lang = {
                ...
                pay_sgas: "CGAS",
                pay_sgas_desc: "CGASはBlaCat提供されたトークンです",
                pay_send: "お引出し",
                pay_purchase: "買う",
                ...
                pay_makeRefundSgasNotEnoughUtxo: "CGAS為替、後でもう一度試してください！",
                pay_makeRefundSgasNotEnough: "CGAS残高不足",
                ...
                pay_makeRefundSgasOldNotEnough: "CGAS(old)残高不足",
                ...
                pay_transferGas_toaddr: "アドレス",
                pay_transferGas_count: "金額",
                ...
                main_refund_second_fail: "転換契約リクエスト（utxo->gas）失敗",
        ...
        change2test(callback) {
            return __awaiter(this, void 0, void 0, function* () {
                this.selectNode(() => {
                    ...
                    BlackCat.tools.CoinTool.id_BTC_NEP5 = "0x93ae7faf78f67c9753e768a3c6ffcfd974ea1c6f";
        ...
        changeInputImg() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                this.reader.onload = () => {
                    ...
                    this.displayImg.src = this.reader.result.toString();
    ...
    class PayExchangeBCPView extends BlackCat.ViewBase {
        ...
        showBuy(clear = 0) {
            ...
            buyObj_buy_btn.onclick = () => __awaiter(this, void 0, void 0, function* () {
                BlackCat.Main.viewMgr.change("ViewLoading");
                try {
                    var res = yield BlackCat.ApiTool.getOtherAddress(BlackCat.Main.user.info.uid, BlackCat.Main.user.info.token, this.exchange_coin_name.toLowerCase());
                }
                catch (e) {
                }
                BlackCat.Main.viewMgr.viewLoading.remove();
...
(function (BlackCat) {
    class PayExchangeBCTView extends BlackCat.ViewBase {
        constructor() {
            super(...arguments);
            this.num = ["10", "100", "500", "1000"];
            this.gift = ["赠送10BCT", "赠送100BCT", "赠送500BCT", "赠送100BCT"];
        }
        create() {
            this.div = this.objCreate("div");
            this.div.classList.add("pc_bj");
            ...
            this.inputamount = this.objCreate("input");
...
(function (BlackCat) {
    class PayExchangeDetailView extends BlackCat.ViewBase {
        ...
        create() {
            ...
            labelBalanceName.textContent = BlackCat.Main.langMgr.get("pay_exchange_NEObalance");
            ...
            btnGas.onclick = () => __awaiter(this, void 0, void 0, function* () {
                ...
                BlackCat.Main.viewMgr.change("ViewLoading");
                try {
                    var res = yield BlackCat.ApiTool.transferByOther(BlackCat.Main.user.info.uid, BlackCat.Main.user.info.token, PayExchangeDetailView.callback_params.type_src.toLowerCase(), PayExchangeDetailView.callback_params.type.toLowerCase(), PayExchangeDetailView.callback_params.price, this.inputGas.value);
                    if (res.r) {
                        let data = res.data;
                ...
                switch (PayExchangeDetailView.callback_params.type_src) {
                    case "BTC":
                        if (BlackCat.tools.CoinTool.id_BTC_NEP5) {
                            this.balance = yield BlackCat.Main.getNep5BalanceByAddress(BlackCat.tools.CoinTool.id_BTC_NEP5, BlackCat.Main.user.info.wallet, 100000000);
                            this.balanceHtmlElement.textContent = BlackCat.Main.getStringNumber(this.balance);
                        }
                        break;
                    case "ETH":
                        if (BlackCat.tools.CoinTool.id_BTC_NEP5) {
                            this.balance = yield BlackCat.Main.getNep5BalanceByAddress(BlackCat.tools.CoinTool.id_ETH_NEP5, BlackCat.Main.user.info.wallet, 100000000);
                            this.balanceHtmlElement.textContent = BlackCat.Main.getStringNumber(this.balance);
                        }
                        break;
                }
...
(function (BlackCat) {
    class PayTransferView extends BlackCat.ViewBase {
        ...
        start() {
            ...
            this.bcpBalance = BlackCat.Main.getStringNumber(BlackCat.Main.viewMgr.payView.bcp);
            this.bctBalance = BlackCat.Main.getStringNumber(BlackCat.Main.viewMgr.payView.bct);
        ...
        create() {
            ...
            optionGas.value = BlackCat.Main.langMgr.get("gas");
            optionGas.innerHTML = BlackCat.Main.langMgr.get("gas");
            this.ObjAppend(this.selectType, optionGas);
            var optionBcp = this.objCreate("option");
            optionBcp.value = BlackCat.Main.langMgr.get("bcp");
            optionBcp.innerHTML = BlackCat.Main.langMgr.get("bcp");
            this.ObjAppend(this.selectType, optionBcp);
            var optionBct = this.objCreate("option");
            optionBct.value = BlackCat.Main.langMgr.get("bct");
            optionBct.innerHTML = BlackCat.Main.langMgr.get("bct");
            ...
            this.divHaveGasAmounts.textContent = "";
...
(function (BlackCat) {
    class PayView extends BlackCat.ViewBase {
        ...
        create() {
            ...
            BCT_btn.textContent = BlackCat.Main.langMgr.get("pay_get");
            ...
            BCP_btn.textContent = BlackCat.Main.langMgr.get("pay_get");
        ...
        doExchangeBCP() {
            return __awaiter(this, void 0, void 0, function* () {
                if (BlackCat.Main.isWalletOpen()) {
                    BlackCat.PayExchangeBCPView.refer = "PayView";
                    this.hidden();
                    BlackCat.Main.viewMgr.change("PayExchangeBCPView");
                }
                else {
                    BlackCat.ViewWalletOpen.refer = "PayView";
                    BlackCat.ViewWalletOpen.callback = () => {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (utxo_counts >= 50) {
                    ...
                    BlackCat.Main.showErrMsg("pay_makeMintGasUtxoCountsLimit", () => {
                        ...
                        BlackCat.Main.viewMgr.change("PayTransferView");
                        BlackCat.Main.viewMgr.payTransferView.inputGasCount.value = mintCount;
                    }, { gas: mintCount });
                    return;
                }
                var sb = new ThinNeo.ScriptBuilder();
            ...
            switch (type) {
                ...
                case "PayExchangeBCPView":
                    ...
                    if (!this.payExchangeBCPView) {
                        this.payExchangeBCPView = new BlackCat.PayExchangeBCPView();
    ...
    class ViewTransCount extends BlackCat.ViewBase {
        ...
        create() {
            ...
            if (ViewTransCount.transTypename1 == "SGASOLD2OLD") {
                ...
                optionSgas.innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + BlackCat.Main.langMgr.get("pay_transCountSGAS2GAS") + "&#xbc635;" + BlackCat.Main.langMgr.get("pay_transCountGAS2SGAS");
                this.ObjAppend(this.selectTransfertype, optionSgas);
                var optionGas = this.objCreate("option");
                optionGas.value = BlackCat.Main.langMgr.get("pay_transCountSGAS2GAS");
                optionGas.innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + BlackCat.Main.langMgr.get("pay_transCountGAS2SGAS") + "&#xbc635;" + BlackCat.Main.langMgr.get("pay_transCountSGAS2GAS");
        ...
        dotransfertype() {
            if (this.selectTransfertype.value == BlackCat.Main.langMgr.get("pay_transCountSGAS2GAS")) {
            ...
            else if (this.selectTransfertype.value == BlackCat.Main.langMgr.get("pay_transCountGAS2SGAS")) {
                this.divHaveGasAmounts.classList.remove("pc_income", "pc_expenditure");
                this.divHaveSGasAmounts.classList.remove("pc_income", "pc_expenditure");
                this.inputCount.value = "";
        ...
        doConfirm() {
            if (ViewTransCount.transTypename1 != "SGASOLD2OLD") {
                if (this.selectTransfertype.value != BlackCat.Main.langMgr.get("pay_transCountSGAS2GAS") && this.selectTransfertype.value != BlackCat.Main.langMgr.get("pay_transCountGAS2SGAS")) {
...
(function (BlackCat) {
    class ApiTool {
        ...
        static getOtherAddress(uid, token, type_src) {
            return __awaiter(this, void 0, void 0, function* () {
                return this.common('wallet_transfer.get_other_address', { uid: uid, token: token, type_src: type_src });
            });
        }
        static transferByOther(uid, token, type_src, type, price, count) {
            return __awaiter(this, void 0, void 0, function* () {
...
(function (BlackCat) {
    ...
    (function (tools) {
        class CoinTool {
            ...
            static contractInvokeTrans_attributes(script, net_fee = "0") {
                return __awaiter(this, void 0, void 0, function* () {
            ...
            static nep5Transaction(address, tatgeraddr, asset, amount, net_fee = "0") {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    sb.EmitAppCall(scriptaddress);
                    var result = yield CoinTool.contractInvokeTrans_attributes(sb.ToArray(), net_fee);
                    return result;
                });
            }
            ...
            static getCgasAssets(id_SGAS = this.id_SGAS, amount) {
                return __awaiter(this, void 0, void 0, function* () {
                    var scriptHash = ThinNeo.Helper.GetAddressFromScriptHash(id_SGAS.hexToBytes().reverse());
